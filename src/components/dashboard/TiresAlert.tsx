...
export const buildTireAlerts = (
  tires: (VehicleTire & {
    vehicles?: { id: string; plate: string; manufacturer: string | null; model: string | null; vehicle_type: string | null } | null;
  })[]
): TireAlertItem[] => {
  ...
  for (const t of tires) {
    ...
    items.push({
      ...
      tire_type: t.type,
      min_tread_mm: minMm,
      reason: lowTread && mismatch ? "both" : lowTread ? "low_tread" : "season_mismatch",
    });
  }
  return items;
};
