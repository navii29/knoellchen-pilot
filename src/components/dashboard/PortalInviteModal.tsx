...
import { AlertTriangle, Check, Copy, Eye, EyeOff, Loader2, Lock, Mail, X } from "lucide-react";

// Portal-Zugang für einen Kunden anlegen/aktualisieren (E-Mail + Passwort).
// Wird im Kunden- UND im Vertrags-Detail verwendet. Die Zugangsdaten werden
// dem Kunden persönlich weitergegeben (kein E-Mail-Versand).
export const PortalInviteModal = ({
  customerId,
  defaultEmail,
  onClose,
  onDone,
            ...
            <div className="space-y-4">
              <div className="rounded-panel border border-hairline bg-canvas px-4 py-3">
                <div className="flex items-center gap-2 text-[13.5px] font-medium text-ink">
                  ...
                  {done.mode === "updated" ? "Passwort aktualisiert" : "Portalzugang erstellt"}
                </div>
