  ...
  <div className="relative mx-auto w-full max-w-[260px] sm:max-w-[300px]">
    <div className="rounded-[36px] bg-zinc-900 p-2.5 shadow-2xl ring-1 ring-white/10">
      <div className="rounded-[28px] bg-white overflow-hidden">
        {/* Statusbar */}
        <div className="flex items-center justify-between px-5 pt-2 pb-1 text-[10px] font-medium text-stone-700">
          <span>9:41</span>
          <span className="flex items-center gap-1">
            <span className="w-3 h-1.5 rounded-[1px] bg-stone-700/80" />
          </span>
        </div>
        {/* Header */}
        <div className="px-4 pt-3 pb-3 border-b border-stone-100 flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-teal-400 to-emerald-500 flex items-center justify-center shadow shadow-teal-500/20">
            <span className="text-white font-bold text-[12px]">M</span>
          </div>
          <div className="flex-1 min-w-0">
            <div className="text-[8.5px] uppercase tracking-wider text-stone-500 font-medium">
              Kundenportal
            </div>
        ...
        <div className="px-4 pt-3 pb-2">
          <div className="flex items-center justify-between mb-1">
            ...
            <div className="text-[10px] font-medium text-stone-700">
              Fahrzeug-Fotos
            </div>
          </div>
        ...
        <div className="px-4 pb-4 pt-2">
            ...
            {[
              ...
              >
                <div className="flex items-center gap-1.5">
                  ...
                  <div className="text-[9.5px] font-medium text-stone-900 truncate">
                    {it.label}
                  </div>
                </div>
              </div>
          ...
          {/* Submit */}
          <div className="mt-3 h-9 rounded-full bg-stone-900 text-white text-[10.5px] font-medium flex items-center justify-center gap-1">
