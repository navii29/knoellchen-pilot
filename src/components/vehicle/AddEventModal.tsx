...
export const AddEventModal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
      ...
      />
      <div className="relative w-full sm:max-w-2xl max-h-[90vh] flex flex-col bg-white sm:rounded-2xl rounded-t-2xl shadow-2xl ring-1 ring-zinc-200 overflow-hidden">
        ...
        <div className="px-6 py-5 overflow-auto scroll-thin grow">
          ...
          <div className="mt-5">
            ...
            <label className="flex items-center gap-3 px-3 py-2.5 rounded-lg ring-1 ring-zinc-200 hover:ring-zinc-300 cursor-pointer text-sm text-zinc-700">
        ...
        <div className="px-6 py-4 flex items-center justify-end gap-3 border-t border-zinc-100 shrink-0">
          ...
          <button
            ...
            onClick={submit}
            disabled={loading}
            className="inline-flex items-center justify-center h-10 px-5 rounded-full bg-zinc-900 text-white text-sm font-medium hover:bg-zinc-800 disabled:opacity-40"
          >
