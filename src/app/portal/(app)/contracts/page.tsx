...
export default async function PortalContractsPage() {
  ...
  return (
    <div className="px-5 py-3">
      ...
      {list.length === 0 ? (
        <div className="rounded-2xl bg-white ring-1 ring-zinc-200 px-5 py-8 text-center text-sm text-zinc-500">
          ...
          {list.map((c) => (
            ...
            >
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 flex-wrap text-[12.5px] text-zinc-500">
                  <span className="font-mono text-zinc-700">{c.plate}</span>
                  <span>·</span>
                  <span>{c.contract_nr}</span>
                </div>
                <div className="text-[14.5px] text-zinc-900 font-medium truncate mt-0.5">
