...
const PortalInviteModal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center px-4">
      ...
      />
      <div className="relative w-full sm:max-w-md max-h-[90vh] flex flex-col bg-white sm:rounded-2xl rounded-t-2xl shadow-2xl ring-1 ring-zinc-200 overflow-hidden">
          ...
          {!done ? (
            <div className="space-y-4">
              ...
              <label className="block">
                <div className="text-[12px] font-medium text-zinc-700 mb-1.5 flex items-center gap-1.5">
              ...
              <label className="block">
                <div className="text-[12px] font-medium text-zinc-700 mb-1.5 flex items-center gap-1.5">
                  ...
                  Passwort
                  <span className="ml-auto text-[11px] text-zinc-400 font-normal">
                    min 8 Zeichen
                  </span>
                </div>
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-xl ring-1 ring-zinc-200 divide-y divide-zinc-100">
                <CredRow
                  label="E-Mail"
                  value={done.email}
                  onCopy={() => copy("email")}
              ...
              <button
                type="button"
                onClick={() => copy("both")}
                className="w-full inline-flex items-center justify-center gap-1.5 h-10 rounded-full ring-1 ring-zinc-200 text-sm text-zinc-700 hover:bg-zinc-50"
              >
...
const CredRow = ({
  ...
  <div className="flex items-center gap-3 px-3.5 py-2.5">
    <div className="text-[11.5px] uppercase tracking-wider text-zinc-500 font-medium w-20 shrink-0">
      {label}
    </div>
    <div
      className={`flex-1 min-w-0 truncate text-zinc-900 ${mono ? "font-mono text-[13.5px]" : "text-[14px]"}`}
    >
      {value}
    </div>
    <button
      type="button"
      onClick={onCopy}
      className="inline-flex items-center gap-1 text-xs text-zinc-500 hover:text-zinc-900 shrink-0"
    >
