    ...
    <div className="flex-1 overflow-auto scroll-thin bg-zinc-50">
      <div className="max-w-4xl mx-auto px-4 md:px-8 py-6 md:py-10">
        ...
        <div className="flex items-start justify-between gap-4 flex-wrap mb-5">
          <div>
            <div className="text-[12px] uppercase tracking-[0.08em] font-semibold text-indigo-700 mb-1">
              Mietvertrag unterschreiben
            </div>
            <h1 className="font-display text-zinc-900 text-[28px] sm:text-[36px] leading-[1.1] tracking-[-0.02em] font-medium">
              {contractNr}
            </h1>
            <div className="mt-1 text-sm text-zinc-500">
              <span className="font-medium text-zinc-700">{renterName}</span>
        ...
        {/* PDF-Vorschau */}
        <div className="rounded-xl bg-white ring-1 ring-zinc-200 overflow-hidden mb-5">
        ...
        <div className="rounded-xl bg-white ring-1 ring-zinc-200 p-4 sm:p-5 mb-5">
          <div className="flex items-center justify-between mb-3 flex-wrap gap-2">
            <div className="flex items-center gap-2 text-[12px] uppercase tracking-wider text-zinc-500 font-semibold">
            ...
            <button
              ...
              onClick={clear}
              disabled={!hasInk}
              className="inline-flex items-center gap-1 text-xs text-zinc-500 hover:text-zinc-900 disabled:opacity-40"
            >
          ...
          <div
            className="relative rounded-lg ring-1 ring-zinc-200 bg-zinc-50 overflow-hidden"
          ...
          >
            ...
            />
            {!hasInk && (
              <div className="pointer-events-none absolute inset-0 flex items-center justify-center text-[13px] text-zinc-400">
        ...
        {/* Bestätigung */}
        <label className="rounded-xl bg-white ring-1 ring-zinc-200 p-4 mb-5 flex items-start gap-3 cursor-pointer">
          <input
            type="checkbox"
            checked={accepted}
        ...
        <div className="sticky bottom-0 -mx-4 md:mx-0 px-4 md:px-0 py-4 md:py-0 bg-zinc-50/90 backdrop-blur md:backdrop-blur-0 md:bg-transparent flex justify-end">
          <button
            type="button"
            onClick={submit}
            disabled={submitting || !hasInk || !accepted}
            className="inline-flex items-center justify-center gap-1.5 h-12 px-6 rounded-full bg-zinc-900 text-white text-[14.5px] font-medium hover:bg-zinc-800 disabled:opacity-40 disabled:cursor-not-allowed"
          >
            {submitting ? (
