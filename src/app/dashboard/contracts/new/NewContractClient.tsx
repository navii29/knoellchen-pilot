...
export const NewContractClient = ({
  ...
  const handlePdfUpload = async (file: File) => {
    ...
    setData({
      ...
      insurance_type: d.insurance_type || "full",
      insurance_deductible: d.insurance_deductible != null ? String(d.insurance_deductible) : "",
      special_terms: d.special_terms || "",
      delivery_cost: d.delivery_cost != null ? String(d.delivery_cost) : "0",
      pickup_cost: d.pickup_cost != null ? String(d.pickup_cost) : "0",
      driver2_name: "",
      driver2_license: "",
      damages_at_handover: d.damages_at_handover || "Keine",
      keys_count: d.keys_count != null ? String(d.keys_count) : "1",
    });
