...
import { parseContractImage } from "@/lib/anthropic";
...
export const POST = async (req: Request) => {
  ...
  let parsed;
  try {
    parsed = await parseContractImage(buf.toString("base64"), mediaType as "image/jpeg" | "image/png" | "image/webp" | "application/pdf");
  } catch (e) {
